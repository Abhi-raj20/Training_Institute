                            ...
                            <div class="row g-0">
                              ...
                              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                  ...
                                  <form  class="form" action="acceptAdmin" method="POST">
                  
                                    <div class="d-flex align-items-center mb-3 pb-1">
								
                                      <i class="fa fa-cubes fa-2x me-3" style="color: #9A616D;"></i>
                                    ...
                                    <div class="form-outline mb-4">
                                      ...
                                      <input type="submit" class="btn btn-block btn-danger btn-large"  value="ADMIN LOGIN" >
                
                  
                                    <!--<a class="small text-muted" href="#!">Forgot password?</a>-->
                                    <!-- <p class="mb-5 pb-lg-2" style="color: #9A616D;">Don't have an account? <a href="#!" style="color: #9A616D;;">Register here</a></p> -->
									<p></p>
									<br>
									<p align="center">
