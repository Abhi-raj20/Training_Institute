    ...
    <div class="container">
        <div class="class-wrapper">
            ...
            <table class="table table-striped table hover">
                ...
                var="request" varStatus="loopCounter">
                ...
                <tr>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col">
									<c:choose>
										<c:when test="${not request.status and not request.rejected}">
											<a
												href="../approveStudentRequest/${request.requestID}">
								...
								<div class="col">
									...
									<c:choose>
										<c:when test="${not request.status and not request.rejected}">
											<a
												href="../rejectStudentRequest/${request.requestID}">
