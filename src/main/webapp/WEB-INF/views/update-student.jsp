            ...
            <div class="row align-items-center justify-content-between d-flex">
              ...
              <!-- <nav id="nav-menu-container">
                <ul class="nav-menu">
                   ...
                   <li><a href="student-home.jsp">Back to Dashboard</a></li	>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         ...
                         <select class="form-control form-control-lg"  id="qualification" name="qualification">
                        ...
                        <label class="form-label select-label" for="qualification">Qualification</label>
                    </div>
                      ...
                      <div class="d-flex justify-content-center">
                        <input type="submit" class="btn btn-block btn-danger btn-large"  value="UPDATE STUDENT"  onclick="Update();">
                      </div>
