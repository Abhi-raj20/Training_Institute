                ...
                <div class="card" style="border-radius: 15px;">
                  <div class="card-body p-5">
                    ...
                    <form class="form" action="registerCourse" method="POST">
                      ...
                      <div class="form-group">
                        <input type="text"  id="seats" name="seats" class="form-control form-control-lg" >
                        <label class="form-label" for="seats">Course Seats</label>
                      </div>
      
                      <div class="d-flex justify-content-center">
                        <input type="submit" class="btn btn-block btn-danger btn-large" value="ADD COURSE" >
                      </div>
